<div class="container-fluid py-4">
    <h2 class="titulo text-center">Editar Libro</h2>
    <!--Validacion -->
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 m-auto login-form card">
        ...
        <form action="<?= base_url('modificar/' . $old['id_producto']) ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-end pt-5 productos-btn">
                <button type="submit" class="btn btn-success btn-estilos btn-continuar">Actualizar</button>
                <a href="<?= base_url('listaProductos') ?>" class="btn btn-danger btn-estilos btn-cancelar">Cancelar</a>
            </div>
